...
return [
    ...
    'how_page_money_3' => 'Stornierungen und bestätigte Streitfälle schreiben Guthaben zurück in Ihr Wallet.',
    ...
    'refund_section_1_body' => 'Bei Auftragserteilung wird Guthaben in Ihrem EUR-Wallet reserviert. Kann ein Publisher nicht wie vereinbart liefern, lehnt er ab oder wird ein Fall vor Freigabe bestätigt, kehrt das reservierte Guthaben als ausgebbares Wallet-Guthaben zurück. Vor der Freigabe nutzen Sie den Order-Chat für Revisionen — das Guthaben bleibt reserviert. Erstattungen für Marktplatzaufträge sind Wallet-Guthaben — keine automatische Barerstattung auf Karte oder Bankkonto.',
    ...
    'refund_section_5_body' => 'Publisher müssen abgeschlossene Placements wie vereinbart live halten. Wird ein abgeschlossener Link oder Artikel entfernt, melden Sie das aus dem Auftrag innerhalb von 30 Tagen nach Abschluss. Nur abgeschlossene Aufträge; pro Positionszeile gilt ein offener oder bestätigter Streitfall. Bei Bestätigung erstatten wir den Betrag als Wallet-Guthaben und holen die Publisher-Auszahlung zurück. Wurden Mittel bereits abgehoben, entsteht eine Schuld und weitere Publisher-Auszahlungen bleiben gesperrt, bis sie geklärt ist. Nach dem 72-Stunden-Auto-Approve ist „Ich habe meine Meinung geändert“ kein Erstattungsgrund — der Link-Entfernungs-Pfad gilt, wenn das Live-Placement entfernt wurde.',
    ...
    'refund_section_7_body' => 'Alle Guthaben werden in Euro geführt. Sie laden Ihr Wallet zuerst auf — per Karte über Stripe oder per Überweisung nach Bestätigung — und bezahlen Placements beim Checkout. Kartendaten verarbeitet Stripe; sie erreichen unsere Server nie. Beim Checkout wird der Betrag reserviert, nicht sofort ausgezahlt: Der Publisher wird erst gutgeschrieben nach Ihrer Freigabe der Live-URL oder automatisch 72 Stunden nach Einreichung, wenn Sie nicht reagieren oder keine Änderungen verlangen. Bei Storno oder bestätigtem Streitfall kehrt das Geld als Wallet-Guthaben zurück.',
    ...
    'refund_faq_a_1' => 'Erstattungen und bestätigte Streitfälle kehren als Wallet-Guthaben zurück, das Sie für ein weiteres Placement nutzen können — nicht als automatische Barerstattung auf Karte oder Bank.',
