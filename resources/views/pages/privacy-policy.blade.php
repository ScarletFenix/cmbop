...
<div class="container py-5" style="max-width:900px;">
    ...
    <div id="info-collect" class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section1_title') }}</h2>
        </div>

        <h3 class="fw-bold mt-4 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section1_sub1') }}</h3>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section1_text1') }}</p>
        <ul class="mb-3" style="color:#555; line-height:2;">
            <li>{{ __('messages.privacy_section1_list1_1') }}</li>
            <li>{{ __('messages.privacy_section1_list1_2') }}</li>
            <li>{{ __('messages.privacy_section1_list1_3') }}</li>
            <li>{{ __('messages.privacy_section1_list1_4') }}</li>
        </ul>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section1_text2') }}</p>

        <h3 class="fw-bold mt-4 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section1_sub2') }}</h3>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section1_text3') }}</p>
        <ul class="mb-3" style="color:#555; line-height:2;">
            <li>{{ __('messages.privacy_section1_list2_1') }}</li>
            <li>{{ __('messages.privacy_section1_list2_2') }}</li>
            <li>{{ __('messages.privacy_section1_list2_3') }}</li>
            <li>{{ __('messages.privacy_section1_list2_4') }}</li>
            <li>{{ __('messages.privacy_section1_list2_5') }}</li>
        </ul>

        <h3 class="fw-bold mt-4 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section1_sub3') }}</h3>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section1_text4') }}</p>
        <p class="mb-0" style="color:#555; line-height:1.7;">{{ __('messages.privacy_section1_text5') }}</p>
    </div>
    ...
    <div id="info-use" class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section2_title') }}</h2>
        </div>

        <h3 class="fw-bold mt-3 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section2_sub1') }}</h3>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section2_text1') }}</p>
        <ul class="mb-4" style="color:#555; line-height:2;">
            <li>{{ __('messages.privacy_section2_list1_1') }}</li>
            <li>{{ __('messages.privacy_section2_list1_2') }}</li>
            <li>{{ __('messages.privacy_section2_list1_3') }}</li>
            <li>{{ __('messages.privacy_section2_list1_4') }}</li>
        </ul>

        <h3 class="fw-bold mt-4 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section2_sub2') }}</h3>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section2_text2') }}</p>
        ...
        <div class="mt-4 p-4 rounded-3" style="background:#eff6ff; border-left:4px solid #3b82f6;">
            <div class="d-flex align-items-start gap-2 mb-2">
                ...
                <h4 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.05rem;">{{ __('messages.privacy_section2_callout_title') }}</h4>
            </div>
            <p class="mb-0" style="color:#555; line-height:1.7;">{{ __('messages.privacy_section2_callout_text') }}</p>
        </div>
    </div>
    ...
    <div id="info-share" class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section3_title') }}</h2>
        </div>

        <h3 class="fw-bold mt-3 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section3_sub1') }}</h3>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section3_text1') }}</p>
        <ul class="mb-3" style="color:#555; line-height:2;">
            <li>{{ __('messages.privacy_section3_list1_1') }}</li>
            <li>{{ __('messages.privacy_section3_list1_2') }}</li>
            <li>{{ __('messages.privacy_section3_list1_3') }}</li>
            <li>{{ __('messages.privacy_section3_list1_4') }}</li>
        </ul>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section3_text2') }}</p>

        <!-- Warning Callout -->
        <div class="mt-4">
            <x-ui.callout variant="attention">
                <strong class="d-block mb-1">{{ __('messages.privacy_section3_callout_title') }}</strong>
                {{ __('messages.privacy_section3_callout_text') }}
            </x-ui.callout>
        </div>

        <h3 class="fw-bold mt-4 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section3_sub2') }}</h3>
        <p class="mb-0" style="color:#555; line-height:1.7;">{{ __('messages.privacy_section3_text3') }}</p>
    </div>
    ...
    <div id="data-security" class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section4_title') }}</h2>
        </div>

        <h3 class="fw-bold mt-3 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section4_sub1') }}</h3>
        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section4_text1') }}</p>

        <h3 class="fw-bold mt-4 mb-3" style="color:#1a1a2e; font-size:1.15rem;">{{ __('messages.privacy_section4_sub2') }}</h3>
        <p class="mb-0" style="color:#555; line-height:1.7;">{{ __('messages.privacy_section4_text2') }}</p>
    </div>
    ...
    <div id="data-retention" class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section5_title') }}</h2>
        </div>

        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section5_text1') }}</p>
    ...
    <div id="your-rights" class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section6_title') }}</h2>
        </div>

        <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section6_text1') }}</p>
        <ul class="mb-4" style="color:#555; line-height:2;">
            <li>{{ __('messages.privacy_section6_list1_1') }}</li>
            <li>{{ __('messages.privacy_section6_list1_2') }}</li>
            <li>{{ __('messages.privacy_section6_list1_3') }}</li>
            <li>{{ __('messages.privacy_section6_list1_4') }}</li>
            <li>{{ __('messages.privacy_section6_list1_5') }}</li>
            <li>{{ __('messages.privacy_section6_list1_6') }}</li>
            <li>{{ __('messages.privacy_section6_list1_7') }}</li>
        </ul>
        ...
        <div class="p-4 rounded-3" style="background:#f0fdf4; border-left:4px solid #4CAF50;">
            <div class="d-flex align-items-start gap-2 mb-2">
                ...
                <h4 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.05rem;">{{ __('messages.privacy_section6_callout_title') }}</h4>
            </div>
            <p style="color:#555; line-height:1.7;">{{ __('messages.privacy_section6_callout_text1') }}</p>
            ...
            <p class="mb-0" style="color:#555; line-height:1.7;">{{ __('messages.privacy_section6_callout_text2') }}</p>
        </div>
    </div>
    ...
    <div id="children-privacy" class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-3">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section7_title') }}</h2>
        </div>
        <p class="mb-0" style="color:#555; line-height:1.7;">{{ __('messages.privacy_section7_text1') }}</p>
    </div>
    ...
    <div class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-3">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section8_title') }}</h2>
        </div>
        <p class="mb-0" style="color:#555; line-height:1.7;">{{ __('messages.privacy_section8_text1') }}</p>
    </div>
    ...
    <div class="mb-5 p-4 p-md-5 rounded-4 shadow-sm" style="background:white; border:1px solid #eef0f3;">
        <div class="d-flex align-items-center gap-3 mb-3">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a1a2e; font-size:1.5rem;">{{ __('messages.privacy_section9_title') }}</h2>
        </div>
        <p class="mb-0" style="color:#555; line-height:1.7;">{{ __('messages.privacy_section9_text1') }}</p>
    </div>
    ...
    <div id="contact-info" class="mb-5 p-4 p-md-5 rounded-4" style="background:linear-gradient(135deg, #5bc4c7, #38b2ac); box-shadow:0 15px 35px rgba(63, 174, 178,0.25);">
        <h2 class="fw-bold mb-4" style="color:white; font-size:1.5rem;">{{ __('messages.privacy_section10_title') }}</h2>
        <p style="color:rgba(255,255,255,0.9); line-height:1.7; margin-bottom:1.25rem;">
            {{ __('messages.privacy_section10_text1') }}
        </p>
