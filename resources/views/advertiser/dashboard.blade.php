...
.recent-orders-glass {
    position: relative;
    /* Grow with content; stretch to match sibling column without forcing overflow */
    min-height: 100%;
    width: 100%;
    border-radius: 18px;
    ...
    box-shadow:
        0 10px 24px rgba(11, 98, 102, 0.08),
...
.dash-command-surface {
    position: relative;
    border-radius: 20px;
    /* Extra bottom padding so glass/shadow never sits flush against the footer */
...
<div class="dash-command-surface">
    <!-- KPIs -->
    ...
    <div class="help-secondary mx-1 mb-0">
