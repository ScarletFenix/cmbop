...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <div>
            ...
            <p class="text-muted mb-0">Seed, edit, activate, deactivate, assign, image, metrics, and bulk updates. Append-only and permanent.</p>
        </div>
    ...
    @endif
    @if($logs->total() > 0)
        <p class="small text-muted mb-2" data-history-count>
            Showing {{ $logs->firstItem() }}–{{ $logs->lastItem() }} of {{ $logs->total() }}
            {{ \Illuminate\Support\Str::plural('task', $logs->total()) }}
        </p>
