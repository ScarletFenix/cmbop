...
return new class extends Migration
{
    ...
    private function replaceSiteIdForeign(string $onDelete): void
    {
        ...
        try {
            ...
            // Orphan site_id rows or a leftover FK name. App code already
            // blocks site delete when order items exist — do not abort the
            // batch before welcome_bonus_settings.
        }
    }
};
