...
| `/assets/img/email-logo.png` | **Email / invoice wordmark** (white background, Final B) |
...
| File | Upload as |
|------|-----------|
| `linkedin/linkedin-profile-300x300.png` | Profile / company logo (300×300) |
| `linkedin/linkedin-profile-400x400.png` | Profile photo (400×400) |
| `linkedin/linkedin-logo-300x300.png` | Company logo |
| `linkedin/linkedin-cover-personal-1584x396.png` | Personal cover |
| `linkedin/linkedin-cover-company-1128x191.png` | Company page cover |

## Trustpilot

| File | Upload as |
|------|-----------|
| `trustpilot/trustpilot-profile-512x512.png` | Business profile image |
